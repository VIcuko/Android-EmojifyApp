...
class Emojifier {
    ...
    static void detectFaces(Context context, Bitmap picture) {
        ...
        // TODO (2): Iterate through the faces, calling getClassifications() for each face. - Done

        // Release the detector
        detector.release();
    }

    // TODO (1): Create a static method called getClassifications() which logs the - Done
