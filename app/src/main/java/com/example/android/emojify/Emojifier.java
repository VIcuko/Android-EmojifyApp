...
class Emojifier {
    ...
    static Bitmap detectFacesAndOverlayEmoji(Context context, Bitmap picture) {
        ...
        // TODO (7): Create a variable called resultBitmap and initialize it to the original - Done
        ...
        if(faces.size() == 0) {
            ...
            for (int i = 0; i < faces.size(); ++i) {
                ...
                // TODO (5): Create a switch statement on the result of the whichEmoji() - Done
                ...
                // TODO (8): Call addBitmapToFace(), passing in the resultBitmap, the emojiBitmap - Done
        ...
        detector.release();
        // TODO (9): Return the resultBitmap - Done
        return resultBitmap;
    }
    ...
    private static Emoji whichEmoji(Face face) {
        ...
        // TODO (1): Change the return type of the whichEmoji() method from void to Emoji. - Done
        ...
        // TODO (2): Have the method return the selected Emoji type. - Done
        return emoji;
    }
